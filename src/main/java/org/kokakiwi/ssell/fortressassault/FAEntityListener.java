...
import org.kokakiwi.ssell.fortressassault.FAPvPWatcher;
...
public class FAEntityListener extends EntityListener {
	...
	/**
	 * Whenever an entity is damaged, this method is called.<br>
	 * <br>
	 * If godEnabled is true, it is checked if the entity is a player. If it is
	 * a player, and the player is on the playerList list, then the damage is
	 * canceled.
	 */
	@Override
